...
class TabManager:
    ...
    def init_dut_tab(self):
        ...
        if hasattr(self, 'notification_manager'):
            ...
            if hasattr(self.dut_ui, 'components'):
                ...
                # 將全域通知管理器傳遞給tooltip管理器
                if hasattr(self.dut_ui.components, 'tooltip_manager'):
                    self.dut_ui.components.tooltip_manager.global_notification_manager = self.notification_manager
    ...
    def init_guide_tab(self):
        ...
        ToolTip(guide_button, "開啟詳細的使用說明文件")
        ToolTip(dos_button, "開啟命令提示字元視窗")
